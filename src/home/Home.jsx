...
const Home = () => {
  return (
    <>
      <div id="fixedlol">
        <h1>News Hub</h1>
        <h2>Stay informed. Get the news that matters.</h2>
        <p>
          Stay informed with our news app,
          <br /> delivering breaking headlines and in-depth <br /> coverage on
          your mobile device.
        </p>
      </div>
      ...
      <div className="p2">
        ...
        <div className="pl__nucleus newnucluous">
          <div className="pl__nucleus-particle newhome"></div>
          <div className="pl__nucleus-particle newhome"></div>
          <div className="pl__nucleus-particle newhome"></div>
          <div className="pl__nucleus-particle newhome"></div>
          <div className="pl__nucleus-particle newhome"></div>
